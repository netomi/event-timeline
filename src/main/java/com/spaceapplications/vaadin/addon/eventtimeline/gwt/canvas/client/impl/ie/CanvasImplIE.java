...
import com.spaceapplications.vaadin.addon.eventtimeline.gwt.canvas.client.impl.CanvasImpl;
...
public class CanvasImplIE extends CanvasImpl {
    ...
    protected native void insert(String where, String html) /*-{
		this.@com.spaceapplications.vaadin.addon.eventtimeline.gwt.canvas.client.impl.CanvasImpl::element.insertAdjacentHTML(where, html);
	}-*/;
